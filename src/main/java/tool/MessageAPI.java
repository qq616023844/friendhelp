...
public class MessageAPI {
	...
	public static void message(String phoneNumber,String code) throws ClientException{
		...
		//替换成你的AK
		final String accessKeyId = "LTAIl0Ptob7ITZ37";//你的accessKeyId,参考本文档步骤2
		final String accessKeySecret = "TwLdPV9iF9WwE7F5xHb5I0hqwXxlNR";//你的accessKeySecret，参考本文档步骤2
